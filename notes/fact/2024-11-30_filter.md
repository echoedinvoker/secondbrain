...
There are some classes that can be used to add filters to elements, such as blur, brightness, contrast, grayscale, hue-rotate, invert, saturate, sepia. They are equivalent to Photoshop's filter effects and can be applied not only to images but also to text.
...
<html lang="en">
  ...
  <body>
    ...
    <!-- all filter classes can works with images and text -->
    <div class="blur-lg">
