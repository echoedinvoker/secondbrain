...
<html lang="en">
  ...
  <body>
    <div class="container mx-auto">
          <!--  ^^^^^^^^^ not like bootstrap `container`, it's only to set mex-width -->
          <!--            and not center the content, so we use `mx-auto` for that   -->
...
-->
      ...
      <div class="flex space-x-4">
             <!-- ^^^^^^^^^^^^^^ instead of `gap`, we use `space-x` with `flex` -->
      ...
      <div class="flex flex-col space-y-4">
             <!-- ^^^^^^^^^^^^^^^^^^^^^^^ instead of `gap`, we use `space-y` with `flex flex-col` -->
        <div class="p-3 bg-red-100">01</div>
        <div class="p-3 bg-red-100">02</div>
        <div class="p-3 bg-red-100">03</div>
      </div>
