  ...
  <body>
    ...
    <div class="relative h-32 w-32 bg-yellow-100">
      <div class="absolute inset-x-0 top-0 h-16 bg-yellow-300">02</div>
                      <!-- ^^^^^^^^^ means span the x-axis to the edges of the parent -->
    </div>

    <!-- Span left edge -->
    <div class="relative h-32 w-32 bg-yellow-100">
      <div class="absolute inset-y-0 left-0 w-16 bg-yellow-300">04</div>
                      <!-- ^^^^^^^^^ means span the y-axis to the edges of the parent -->
    </div>
...
<!-- By default, elements that are further back will be covered by elements in front, but we can use z-index to change this order, elements with a higher z value will cover elements with a lower z value or no z value. -->
    </div>

    <!-- Floats, barely used in tailwind -->
    <div class="w-1/2">
