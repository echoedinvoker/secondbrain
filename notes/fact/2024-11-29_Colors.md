...
<html lang="en">
  ...
  <body>
    ...
    <!-- black and white have no weight -->

    <!-- other colors have weight from 50 to 900 -->
    ...
    <input type="checkbox" class="accent-purple-500" checked /> Option 1
                             <!-- ^^^^^^ be careful, not `checkbox` but `accent` -->
    ...
    <div class="bg-[#427fab] h-10">Hello</div>
              <!-- ^^^^^^^^^ any colors can be replaced with hex code, rgb, rgba, hsl, hsla or even color name -->
