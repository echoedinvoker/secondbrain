...
<html lang="en">
  ...
  <body>
    <!-- Grid cols and rows -->
    <div class="grid grid-cols-3 grid-rows-5 gap-4 w-100 bg-gray-100">
                            <!-- ^^^^^^^^^^^ even all children only take 3 rows, but the grid still occupy 5 rows -->
                            <!--             if you put `grid-rows-t` here -->
    ...
    <div class="grid grid-cols-3 gap-4 w-100 bg-gray-100">
      <div
        class="col-span-2 row-span-2 p-10 border border-blue-600 bg-blue-100"
          <!-- ^^^^^^^^^^^^^^^^^^^^^ we can let the child of the grid to span horizontally or vertically across multiple columns or rows -->
      >
        01
      </div>
      <div class="p-10 border border-blue-600 bg-blue-100">02</div>
    ...
    <!-- common RWD by grid -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 w-100 bg-gray-100">
                <!-- ^^^^^^^^^^^^^^^^^^^^^^^^^^ only one column for small screen, when break to medium screen, it will be 3 columns -->
      <div
        class="md:col-span-2 md:row-span-2 p-10 border border-blue-600 bg-blue-100"
          <!-- ^^^           ^^^  not spanning until break to medium screen, it just make no sense when the screen is small -->
      >
        01
      </div>
      <div class="p-10 border border-blue-600 bg-blue-100">02</div>
      ...
      <div class="p-10 border border-blue-600 bg-blue-100">05</div>
      <div class="p-10 border border-blue-600 bg-blue-100">06</div>
      <div class="md:col-span-3 p-10 border border-blue-600 bg-blue-100">07</div>
             <!-- ^^^ -->
      <div class="p-10 border border-blue-600 bg-blue-100">08</div>
      <div class="md:col-span-2 p-10 border border-blue-600 bg-blue-100">09</div>
             <!-- ^^^ -->
    </div>
  </body>
</html>
